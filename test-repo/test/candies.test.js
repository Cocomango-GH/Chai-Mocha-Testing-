// chai is a lyibrary and language we write in to test 
...
describe("GET /candies", () => {
     ...
     it("should return a 200 response", () => {// this is what you will see 
        ...
        expect(response.status).to.equal(200);// this is the actually test 
    }); 
